...
Set InstallerFolder=MTDBCreatorInstall\Release
...
"c:\program files\winrar\winRar.exe" a -ep %SourceAndSupportingDLLsFile% ..\Data\DatasetsDescription.txt
"c:\program files\winrar\winRar.exe" a -ep %SourceAndSupportingDLLsFile% ..\Data\DatasetsDescription_MinimalColumns.txt
...
"c:\program files\winrar\winRar.exe" a -ep %ZippedInstallerFile% ..\%InstallerFolder%\Setup.*
...
"c:\program files\winrar\winRar.exe" a -ep %ZippedInstallerFile% ..\Data\DatasetsDescription.txt
"c:\program files\winrar\winRar.exe" a -ep %ZippedInstallerFile% ..\Data\DatasetsDescription_MinimalColumns.txt
