    ...
    public class FileDialogFormatInfoFactory
    {
        public static FileDialogFormatInfo Create(string format)
        {
            switch (format)
            {
                ...
                case "MSGFPlus":
                    return new FileDialogFormatInfo("Open MSGF+ analysis files", "MSGF+ Analysis Files |*msgfplus_syn.txt", LcmsIdentificationTool.MsgfPlus);
                case "MZIdentML":
                ...
                case "Analysis Files":
                    return new FileDialogFormatInfo("Open old analysis file type", "Analysis Files |*_syn.txt;*msalign_syn.txt;*msgfplus_syn.txt;*_xt.txt", LcmsIdentificationTool.Sequest);
                case "Description":
