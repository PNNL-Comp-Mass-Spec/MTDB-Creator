...
namespace MTDBCreatorTestSuite.IO
{
    ...
    public class ObservedNetTests : TestBase
    {
        ...
        [Test]
        [TestCase(@"Scanstest\NoScanFile\QC_Shew_13_04_c_500ng_4Jun14_Samwise_14-02-17_msgfplus_syn.txt")]
        [TestCase(@"Scanstest\WithScanFile\QC_Shew_13_04_c_500ng_4Jun14_Samwise_14-02-17_msgfplus_syn.txt")]
