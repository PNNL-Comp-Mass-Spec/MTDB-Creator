...
namespace MTDBCreatorTestSuite.IO
{
    ...
    {
        [Test]
        [TestCase(@"MSGFPlus\61928_SCU_WS_UPool_24_17Sep13_Cheetah_13-07-22_msgfplus_syn.txt", 2189)] // Used to cross-verify the results
        [TestCase(@"MSGFPlus\QC_Shew_13_05-1_03_8Jun14_Samwise_14-02-16_msgfplus_syn.txt", 15384)]    // Used to cross-verify the results
        [TestCase(@"MSGFPlus\QC_Shew_13_05-2_03_8Jun14_Samwise_14-02-17_msgfplus_syn.txt", 15475)]    // Used to cross-verify the results
